...
4. **[docs/GIT_REWRITE_GUIDE.md](docs/GIT_REWRITE_GUIDE.md)** - Guia para reescrever o histórico de commits
...
#### [docs/GIT_REWRITE_GUIDE.md](docs/GIT_REWRITE_GUIDE.md)
**O que é**: Guia para reescrever o histórico de commits
**Tamanho**: ~4 KB
**Contém**:
- ✅ Como usar `git rebase -i --root`
- ✅ Comandos (`squash`, `reword`, `drop`)
- ✅ Como forçar o push (`git push --force`)
- ✅ Avisos sobre os riscos

**Quando usar**: Quando precisar limpar ou alterar o histórico de commits do seu projeto.
...
└─ 📖 CONCEITUAL (Entender)
   ...
   └─ docs/GIT_REWRITE_GUIDE.md (como reescrever o histórico)
```
...
- [x] Guia de rewrite do Git (GIT_REWRITE_GUIDE.md)
...
| Reescrever histórico Git | docs/GIT_REWRITE_GUIDE.md |
